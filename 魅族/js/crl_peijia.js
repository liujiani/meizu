window.onload=function(){
	var crl_show=document.getElementById('crl_w_r').children;
	...
	for(var i=0;i<crl_li.length;i++){
		...
		crl_li[i].onclick=function(){
            for(var i=0;i<crl_li.length;i++){
             ...
             for(var i=0;i<crl_show.length;i++){
             	crl_show[i].style.display='none'
            }
            this.className='active'
			crl_show[this.index].style.display='block'
		}
	}
	//头
